		...
		async function fetchData() {
			try {
				const [
					...
					axios.get("http://aqua-book:80/api/appointments"),
					axios.get("http://aqua-book:80/api/employees"),
					axios.get("http://aqua-book:80/api/service-categories"),
					axios.get("http://aqua-book:80/api/services"),
				]);
