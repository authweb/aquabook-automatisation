...
const Aside = ({
	...
	useEffect(() => {
		...
		const fetchServices = async () => {
			try {
				const response = await fetch("http://aqua-book:3306/api/services");
	...
	useEffect(() => {
		...
		const fetchEmployees = async () => {
			try {
				const response = await fetch("http://aqua-book:3306/api/employees");
				const data = await response.json();
	...
	useEffect(() => {
		...
		const fetchClients = async () => {
			try {
				const response = await fetch("http://aqua-book:3306/api/clients");
				const data = await response.json();
